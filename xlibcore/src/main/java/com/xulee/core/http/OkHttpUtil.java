...
import com.xulee.core.base.BaseApp;
import com.xulee.core.utils.NetworkUtils;
...
public class OkHttpUtil {
    ...
    public OkHttpClient getOkHttpClient(Context context) {
        //缓存路径
        Cache cache = new Cache(new File(context.getCacheDir().getAbsolutePath(), "HttpCache"),
    ...
    public static String getCacheControl() {
        return NetworkUtils.isConnected(BaseApp.getAppContext()) ? CACHE_CONTROL_AGE : CACHE_CONTROL_CACHE;
    }
}