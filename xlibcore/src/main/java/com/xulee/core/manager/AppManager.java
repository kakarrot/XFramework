package com.xulee.core.manager;
...
public class AppManager {
    ...
    public void showSnackbar(String message, boolean isLong) {
        if (getCurrentActivity() == null) {
            Logger.w(TAG, "mCurrentActivity == null when showSnackbar(String,boolean)");
            return;
        }
    ...
    public void startActivity(Intent intent) {
        if (getCurrentActivity() == null) {
            Logger.w(TAG, "mCurrentActivity == null when startActivity(Intent)");
    ...
    public void removeActivity(Activity activity) {
        if (mActivityList == null) {
            Logger.w(TAG, "mActivityList == null when removeActivity(Activity)");
            return;
        }
        synchronized (AppManager.class) {
            if (mActivityList.contains(activity)) {
    ...
    public Activity removeActivity(int location) {
        if (mActivityList == null) {
            Logger.w(TAG, "mActivityList == null when removeActivity(int)");
            return null;
        }
        synchronized (AppManager.class) {
    ...
    public void killActivity(Class<?> activityClass) {
        if (mActivityList == null) {
            Logger.w(TAG, "mActivityList == null when killActivity");
            return;
        }
    ...
    public boolean activityInstanceIsLive(Activity activity) {
        if (mActivityList == null) {
            Logger.w(TAG, "mActivityList == null when activityInstanceIsLive");
            return false;
        }
    ...
    public boolean activityClassIsLive(Class<?> activityClass) {
        if (mActivityList == null) {
            Logger.w(TAG, "mActivityList == null when activityClassIsLive");
            return false;
        }
        for (Activity activity : mActivityList) {
            if (activity.getClass().equals(activityClass)) {
